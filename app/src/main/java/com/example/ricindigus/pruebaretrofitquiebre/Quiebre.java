...
public class Quiebre {
    ...
    public Quiebre(String ambassadorDni, String ambassadorEmail, String ambassadorName, String ambassadorPhone, String codeNetwork, String codeProduct, String codeQuery, String contactPhone, String description, String ownerDni, String ownerEmail, String ownerName, String ownerPhone) {
    ...
    public String getAmbassadorDni() {
        return ambassadorDni;
    }

    public void setAmbassadorDni(String ambassadorDni) {
        this.ambassadorDni = ambassadorDni;
    }
    ...
    public String getAmbassadorPhone() {
        return ambassadorPhone;
    }

    public void setAmbassadorPhone(String ambassadorPhone) {
        this.ambassadorPhone = ambassadorPhone;
    }
